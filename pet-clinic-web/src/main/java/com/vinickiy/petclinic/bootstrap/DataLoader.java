...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        Specialty savedSpecialty = specialtyService.save(radiology);
        ...
        owner2.setAddress("Zhabotinski");
        owner2.setCity("Baku");
        owner2.setTelephone("1234558456");
